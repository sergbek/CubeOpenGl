...
class CubeModel : Shape {
    ...
    val cubeCoords = floatArrayOf(
            ...
            -1.0f, -1.0f, -1.0f, // vertex 4 (x4, y4, z4)
            1.0f, -1.0f, -1.0f, // vertex 5 (x5, y5, z5)
            1.0f, 1.0f, -1.0f, // vertex 6 (x6, y6, z6)
            -1.0f, 1.0f, -1.0f) // vertex 7 (x7, y7, z7)

    val colors = floatArrayOf(
            1.0f, 1.0f, 0.0f, 1.0f, // red for vertex 0
    ...
    init {
        var byteBuffer = ByteBuffer.allocateDirect(cubeCoords.size * 4)
    ...
    override fun draw(gl: GL10) {
        ...
        gl.glDrawElements(GL10.GL_TRIANGLES, drawOrder.size, GL10.GL_UNSIGNED_BYTE, drawListBuffer)
